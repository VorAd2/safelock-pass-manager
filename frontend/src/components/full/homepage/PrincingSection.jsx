            ...
            <Card className={`h-100 ${styles.freeCard}`}>
              <Card.Body className="d-flex flex-column">
                ...
                <div className="mt-auto text-center">
                  <Button className="w-75 fs-5">Start Free</Button>
                </div>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col md={4} className="mb-4">
            <Card className={`h-100 border border-primary ${styles.familyCard}`}> {/* Apenas borda azul claro */}
              <Card.Body className="d-flex flex-column">
                ...
                <div className="mt-auto text-center">
                  <Button className={`w-75 mb-2 fs-5 ${styles.familyBtn1}`}>Subscribe Now</Button>
                  <Button variant="outline-custom" className={`w-75 fs-5 ${styles.familyBtn2}`}>Learn More</Button>
                </div>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col md={4} className="mb-4">
            <Card text="white" className={`h-100 ${styles.businessCard}`}> 
              <Card.Body className="d-flex flex-column">
                ...
                <div className="mt-auto text-center">
                  <Button variant="light" className="w-75 mb-2 fs-5">Subscribe Now</Button>
                  <Button className={`w-75 fs-5 ${styles.demoBtn}`} id='demo-btn'>Request Demo</Button>
                </div>
              </Card.Body>
            </Card>
          </Col>
